        ...
        SelectableList('#events', {
            ...
            filter: event => {
                ...
                const startDate = new Date(
                    new Date(window.hydrate.get('filter_startDate')).toDateString()
                );
                const endDate = new Date(
                    new Date(window.hydrate.get('filter_endDate')).toDateString()
                );
                
                if (window.hydrate.has('filter_startDate')) {
                    if (window.hydrate.has('filter_endDate')) {
